...
result_entry=customtkinter.CTkEntry(app,font=font1,text_color="white",width=250,fg_color="black",bg_color="black",border_color="black")
result_entry.place(x=0,y=10)

Button1=customtkinter.CTkButton(app,command=clear,text="C",text_color="black",font=font1,width=50,height=2,fg_color="orange",hover_color="gold")
Button1.place(x=10,y=60)

Button2=customtkinter.CTkButton(app,command=lambda:show("%"),text="%",text_color="black",font=font1,width=50,height=2,fg_color="azure",hover_color="ivory3")
Button2.place(x=70,y=60)

Button3=customtkinter.CTkButton(app,command=lambda:show("/"),text="/",text_color="black",font=font1,width=50,height=2,fg_color="azure",hover_color="ivory3")
Button3.place(x=130,y=60)

Button4=customtkinter.CTkButton(app,command=lambda:show("*"),text="*",text_color="black",font=font1,width=50,height=2,fg_color="azure",hover_color="ivory3")
...
Button8=customtkinter.CTkButton(app,command=lambda:show("+"),text="+",text_color="black",font=font1,width=50,height=2,fg_color="azure",hover_color="ivory3")
...
Button10=customtkinter.CTkButton(app,command=lambda:show("5"),text="6",font=font1,width=50,height=2,fg_color="#2e2a27",hover_color="#2e2a27")
...
Button12=customtkinter.CTkButton(app,command=lambda:show("-"),text="-",text_color="black",font=font1,width=50,height=2,fg_color="azure",hover_color="ivory3")
...
Button17=customtkinter.CTkButton(app,command=lambda:show("."),text=".",font=font1,width=50,height=2,fg_color="azure",hover_color="#b5520b")
Button17.place(x=10,y=300)

Button18=customtkinter.CTkButton(app,command=calculate,text="=",text_color="black",font=font1,width=170,height=2,fg_color="brown1",hover_color="azure")
